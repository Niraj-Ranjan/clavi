$.get(datahostaddress + "/rates", function (rates) {
    ...
    $.get(datahostaddress + "/canteen/data/available.json", function (availableitems) {
        ...
        for (var category in availableitems) {
            ...
            for (var item in availableitems[category]) {
                ...
                innerdata = innerdata.concat("<div class='col s6 m3'><div class='card'><div class='card-image tiny'><img src='" + datahostaddress + "/canteen/images/" + category + "/" + itemname + ".png'><span class='card-title'>" + itemname + "</span></div><div class='card-action'><a href='#'>Rs. " + rates[category][itemname] + "</a></div></div></div>");
            }
    ...
    $.get(datahostaddress + "/canteen/data/trending.json", function (trendingitems) {
        ...
        for (var itemname in trendingitems) {
            ...
            //console.log(itemname);
            innerdata = innerdata.concat("<div class='col s6 m3'><div class='card'><div class='card-image tiny'><img src='" + datahostaddress + "/canteen/images/" + itemcategory + "/" + itemname + ".png'><span class='card-title'>" + itemname + "</span></div><div class='card-action'><a href='#'>Rs. " + rates[itemcategory][itemname] + "</a></div></div></div>");
